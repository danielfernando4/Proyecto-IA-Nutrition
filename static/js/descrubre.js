document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateFilterButton() {
    const hasActiveFilters = Array.from(allFilters).some(
      (filter) =>
        filter.classList.contains("active") || searchInput.value.trim()
    );
      ...
      button.addEventListener("click", () => {
        ...
        if (recipeData) {
          document.querySelector(".recipe-title").innerText =
            recipeData.nombre_comida;
          document.querySelector(".mod_desc").innerText =
            "Conoce la información nutricional de esta receta.";
          document.querySelector(".recipe-description").innerText =
